...
def main():
    ...
    time.sleep(1)
    randomMentor.do_coding_dojo(student_for_dojo, codecoolObject.students[random.randint(0, 5)])
    time.sleep(3)
    os.system('clear')
    ...
    randomMentor.say_joke(codecoolObject.students[random.randint(0, 5)])
